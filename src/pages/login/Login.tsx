...
import { auth } from '../../../function/models/authService';
...
import { Card, CardContent, CardHeader, CardTitle } from '../../components/login ui/ui/card';
...
export function Login() {
  ...
  // (Optional) Apple login – Firebase doesn’t have native Apple Sign-In on web
  const handleAppleLogin = () => {
    alert('Apple login is not supported directly on Firebase Web. You’ll need a custom OAuth flow.');
  };
      ...
      <CardContent className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-2 text-gray-600">Or sign in with</span>
          </div>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600">
            ...
            <a href="/signup" className="text-black hover:underline transition-colors">
              Create one
            </a>
          </p>
        </div>
